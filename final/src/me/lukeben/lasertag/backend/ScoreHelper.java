...
public class ScoreHelper {
    ...
    public void setSlot(int slot, String text) throws Exception {
        ...
        text = Utils.replaceValues(p, text);
    ...
    public void setSlotsFromList(List<String> list) throws Exception {
        while (list.size() > 15) {
